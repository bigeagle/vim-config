...
" ============
    ...
    syn match   pythonBracket   "[(){}\[\]]" display
...
" =============
    ...
    hi def link  pythonFuncParam    Identifier
    hi def link  pythonFuncSep      Normal
    hi def link  pythonFuncSym      Special
    hi def link  pythonConditional  Conditional
    hi def link  pythonRepeat       Repeat
    hi def link  pythonException    Exception
    hi def link  pythonOperator	    Operator
    hi def link  pythonBracket     Special

    hi def link  pythonDecorator    Define
    hi def link  pythonDottedName   Define
